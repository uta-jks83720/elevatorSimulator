...
Fl_Double_Window* UserInterfaceElevator::make_window() {
  ...
  { Fl_Double_Window* o = new Fl_Double_Window(630, 445, "elevatorSimulator");
    ...
    { Fl_Group* o = new Fl_Group(345, 235, 215, 220, "Cab Controls and Indicators");
      ...
      { REQ4 = new Fl_Text_Display(465, 260, 50, 30);
      } // Fl_Text_Display* REQ4
      { REQ3 = new Fl_Text_Display(465, 290, 50, 30);
      } // Fl_Text_Display* REQ3
      { REQ2 = new Fl_Text_Display(465, 320, 50, 30);
      } // Fl_Text_Display* REQ2
      o->end();
    } // Fl_Group* o
    o->end();
  } // Fl_Double_Window* o
